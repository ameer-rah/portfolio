          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-2 md:gap-4 lg:gap-6 py-4">
            ...
            <div className="flex flex-col justify-center space-y-4 md:space-y-6 md:py-4 min-w-0 md:max-w-xl">
              ...
              <div className="space-y-3 md:space-y-4 w-full text-center md:text-left">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold wrap-break-word">
                  Ameer Rahman
                </h1>
                <p className="text-sm md:text-base lg:text-lg opacity-70 wrap-break-word">
                  ameer[dot]rahman[at]rutgers[dot]edu • ameerrahman456[at]gmail[dot]com
                </p>
              </div>
              ...
              <div className="space-y-3 md:space-y-4 w-full">
                <p className="text-sm md:text-base lg:text-lg leading-relaxed">
                  I enjoy mitigating risks and building software to help people.
                </p>
              ...
              <div className="flex items-center flex-wrap gap-3 md:gap-4 pt-2">
                <a
                  href="https://x.com/uhhhhmeer"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary/80 hover:text-primary transition-colors relative group"
...
<div className="ml-2 h-8 w-px bg-[color-mix(in_oklch,var(--color-primary)_10%,transparent)]"></div>
                ...
                <button
                  onClick={toggleTheme}
                  className="flex items-center text-primary/80 hover:text-primary transition-colors group cursor-pointer"
