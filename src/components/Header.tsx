    ...
    >
      ...
      >
        <motion.div
          ...
          className="space-y-6"
        >
          <p className="font-sans text-[10px] tracking-[0.45em] uppercase text-[#C8A455] font-light">
            Portfolio · 2026
          </p>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
            ...
            <div className="flex items-center gap-6">
              <a href="https://x.com/uhhhhmeer" target="_blank" rel="noopener noreferrer"
                className="text-[#444444] hover:text-[#C8A455] transition-colors duration-300" title="X">
              ...
              <a href="https://github.com/ameer-rah" target="_blank" rel="noopener noreferrer"
                className="text-[#444444] hover:text-[#C8A455] transition-colors duration-300" title="GitHub">
              ...
              <a href="https://linkedin.com/in/ameer-rahman" target="_blank" rel="noopener noreferrer"
                className="text-[#444444] hover:text-[#C8A455] transition-colors duration-300" title="LinkedIn">
      ...
      >
        ...
        <div className="w-px h-12 bg-[#C8A455]/20" />
      </motion.div>
    </section>
  );
}
