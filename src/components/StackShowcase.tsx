...
export default function StackShowcase() {
  return (
    <section className="overflow-hidden border-t border-stone-200 bg-[#10251d]">
      <div className="mx-auto max-w-6xl px-5 py-20 sm:py-24">
        <Card className="relative overflow-hidden border-white/10 bg-[#0b1f18] shadow-[0_28px_80px_-40px_rgba(0,0,0,0.8)]">
